    ...
    <Fragment>
      ...
      <div className="listing">
        ...
        <div className="container pt">
          ...
          <div className="item">
            <Icon color="#52ad34" size={24} className="item__icon item__icon--green" name="verified"/>
            <span className="item__name item__name--large">Hightlands Coffee - 123 Nguyễn Đình Chiểu</span>
          </div>
          <div className="item">
            <Icon color="#b5b5b5" size={18} className="item__icon" name="location_on"/>
            <span className="item__name">213/22/4 Nguyễn Trãi, P.2, Q.5</span>
          </div>
          <div className="item">
            <Icon color="#b5b5b5" size={18} className="item__icon" name="access_time"/>
